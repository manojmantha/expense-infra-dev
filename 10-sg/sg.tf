...
# VPN host should be accessed from office n/w (FOr now I am allow from internet ip address)
...
# VPN host should be accessed from 443
...
# VPN host should be accessed from 943
...
# VPN host should be accessed from 1194
